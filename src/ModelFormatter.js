...
class ModelFormatter {
   ...
   * @return {Array} return model format
   */
  format (tables) {
   ...
   * @param  {Object} column Column schema
   * @return {String} max lenght string
   */
  _maxLength (column) {
   ...
   * @param  {Object} column Column schema
   * @return {String} sanitisor string
   */
   ...
   * @param  {Object} relation Relation schema
   * @return {String} belongs to many string
   */
