...
class FileWriter {
   ...
   * @param  {Object []}  migrations formatted migrations schema
   * @return {Promise<Array>} Written files
   */
  async migrations(migrations) {
    ...
    return Promise.all(migrations.map(async migration => this._generateFile("schema", migration.name, migration, { action: "create" })));
  }

  /**
   * Write models files
   * @param  {Object []}  models formatted models schema
   * @return {Promise<Object>} Written files
   */
  async models(models) {
   ...
   * @param  {Object []}  factories formatted factories schema
   ...
   * @return {Promise<Object>}              Information about success/error and location of new file
   */
